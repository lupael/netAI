...
DEVICES: List[Device] = [
    ...
    Device(
        ...
        firmware_version="RouterOS 7.12.1",
        location="DC2-Core",
        interfaces=14,
    ...
    Device(
        ...
        memory_usage=58.3,
        disk_usage=29.1,
        uptime=4147200,  # 48 days
        firmware_version="SR OS 22.10.R3",
        location="DC2-Core",
        interfaces=20,
        model="Nokia 7750 SR-1",
        vendor="Nokia",
        last_seen=_dt(0),
    ),
    Device(
        ...
        firmware_version="Ubuntu 22.04.3 LTS / 5.15.0-88",
        location="DC2-Compute",
        interfaces=4,
    ...
    Device(
        ...
        memory_usage=28.6,
        disk_usage=16.2,
        uptime=6048000,  # 70 days
        firmware_version="BDcom OS V3.2.1",
        location="Floor-2",
        interfaces=48,
        model="BDcom S3900-48T",
        vendor="BDcom",
        last_seen=_dt(0),
    ),
]
